...
// Attention : il y a certains modules dont on a plus besoin
...
//   printf("-------------------------\n");
//
//   int k = minCapa(reseau, chemin);
//   printf("minCapa=%d\n", k);
//
//   printf("-------------------------\n");
//
//   updateFlowInRG(RG, chemin, k);
//   // Là pour vérifier que le graphe est bien mis à jour, on affiche le graphe
//   :
//
//   printf("------------RG MIS A JOUR-----------\n");
//   imprimer_liste_chainee(RG->tab[0]);
//   imprimer_liste_chainee(RG->tab[1]);
//   imprimer_liste_chainee(RG->tab[2]);
//   imprimer_liste_chainee(RG->tab[3]);
...
//   printf("-------------------------------------------\n");
//
//   // On update le flow dans le réseau
//   updateFlowInNet(reseau, RG);
//   printf("------------NET MIS A JOUR-----------\n");
//   imprimer_liste_chainee(reseau->tab[0]);
//   imprimer_liste_chainee(reseau->tab[1]);
//   imprimer_liste_chainee(reseau->tab[2]);
//   imprimer_liste_chainee(reseau->tab[3]);
